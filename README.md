...
The development PC stays connected to the G1 by Ethernet and runs the controller service. Install the official Unitree Python SDK and this project while the PC has internet access.
